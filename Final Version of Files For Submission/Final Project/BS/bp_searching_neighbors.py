...
print(f"[ANALYSIS RESULT]: The average f1-score is: {average_f1} +/- {std_f1}")
print(f"[ANALYSIS RESULT]: The average recall is: {average_recall} +/- {std_recall}")
print(f"[ANALYSIS RESULT]: The average precision is: {average_precision} +/- {std_precision}")
